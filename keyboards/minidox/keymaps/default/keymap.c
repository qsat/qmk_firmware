...
[_QWERTY] = LAYOUT( \
  ...
  CTL_T(KC_Z), ALT_T(KC_X),    KC_C,    KC_V,    KC_B,         KC_N,    KC_M,    KC_COMM, ALT_T(KC_DOT),  CTL_T(KC_ENT), \
                       GUI_T(KC_ESC), LOWER,   SFT_T(KC_ENT),      KC_SPC,  RAISE,   GUI_T(KC_BSPC)             \
),
...
[_LOWER] = LAYOUT( \
  ...
  KC_TILD,  _______, _______, _______, _______,      _______, KC_UNDS,    KC_PLUS,     KC_LCBR,   KC_RCBR, \
  KC_BSLS,  _______, _______, _______, _______,      _______, S(KC_QUOT), S(KC_COMM),  S(KC_DOT), KC_QUES, \
